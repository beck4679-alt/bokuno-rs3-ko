...
| 3 | 한국어 패치 `bokuno_ko_v0.110.xdelta` | [Releases](https://github.com/beck4679-alt/bokuno-rs3-ko/releases/latest) |
...
2. **Patch file** 칸에서 `bokuno_ko_v0.110.xdelta` 를 고릅니다.
3. **Apply patch** 를 누르면 한국어 롬이 내려받아집니다. 파일 이름은 마음대로 바꿔도 됩니다(예: `bokuno_ko.sfc`).
4. 확인: 한국어 롬을 **ROM file** 칸에 넣었을 때 **CRC32 `5E531265`**, SHA-1 `732780651DFE5658CFDD4758307DB4A3F57AD471` 이면 완성입니다.
...
3. **XDelta patch** 오른쪽 단추로 `bokuno_ko_v0.110.xdelta` 를 고릅니다.
...
| 한국어 롬 (B-2 결과) | `15F1633C4914ED99CE26E0EFA958D0AD0D198AA19B531E6A9F6F71E8DCD51C6B` |
