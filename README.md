...
**[최신 패치 다운로드](https://github.com/beck4679-alt/bokuno-rs3-ko/releases/download/v0.110/bokuno_ko_v0.110.xdelta)** · [설치 가이드](docs/INSTALL.md) · [변경 내역](docs/CHANGELOG.md)

> **v0.110 · 2026.09.24** — 구시가 대사와 불필요한 줄바꿈을 수정했습니다. 현재 검수 진행 중입니다.
...
- 구시가에서 루트비히에게 쫓긴 사람들을 설명하는 대사가 불필요하게 밀리던 문제를 고쳤습니다.
- 스탠리·왕가의 반지·용병 모집 등 대사의 줄바꿈을 다듬었습니다.
- 같은 문구를 사용하는 다른 대화와 좁은 창에서의 영향을 다시 검사했습니다.

v0.109까지의 수정을 포함하는 누적 패치입니다. [자세한 수정·검증 범위](docs/releases/v0.110.md)
