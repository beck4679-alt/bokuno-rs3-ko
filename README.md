...
| | |
|---|---|
| **현재 판** | **v0.98** (2026-09-10, 검수 후보) |
| **다운로드** | [bokuno_ko_batch5z_20260910_98.xdelta](https://github.com/beck4679-alt/bokuno-rs3-ko/releases/download/v0.98/bokuno_ko_batch5z_20260910_98.xdelta) · [변경 내역](https://github.com/beck4679-alt/bokuno-rs3-ko/releases/tag/v0.98) |
...
| 3 | 한국어 패치 `bokuno_ko_batch5z_20260910_98.xdelta` | [Releases](https://github.com/beck4679-alt/bokuno-rs3-ko/releases/latest) |
...
```text
xdelta3 -d -s ぼくのProto1.123.smc bokuno_ko_batch5z_20260910_98.xdelta bokuno_ko.smc
```

결과 SHA256 이 `02AE4AE27686875480AB14B31D63E65A9CE282813C3B7015F70AC5F8ACB5D9C2` 이면 정상입니다.
...
전투 화면 글자 간격을 손본 판입니다. v0.97 까지의 수리를 그대로 포함합니다.

- 전투의 캐릭터·적 명판, 기술 이름 풍선, 커맨드·기술 목록에서 한글이 16px 간격으로 벌어지던 것(「사 라」「사 냥 꾼 의 활」)을 대사 창과 같은 8px 간격으로 붙였습니다. 외곽선은 대사 창처럼 오른쪽·아래 그림자만 남겨 글자끼리 겹치지 않습니다. 일본어·숫자·WP 표시는 그대로입니다.
- 메뉴·상태창·캐릭터 생성창은 다른 글자 루틴이라 바꾸지 않았습니다(16px 그대로).
- v0.97: 원문 줄 폭 정정과 줄 배분 되돌리기, 후작 의뢰 문안 오류 수리. v0.94: 선택지 강조(빨간 줄) 표시 수리. v0.92: 대사 줄 배분 전수 대조·수리.
- 검증: 에뮬레이터 전투 스테이트에서 명판 5종·기술 풍선·커맨드/기술 목록 확인, 안전 빌드 7관문, 에뮬레이터 이벤트 31개 관문, 제어 바이트 무손상, 비대사 표 654항목 되읽기 일치, 독립 디코더로 패치 복원 SHA256 일치.
...
| 파일 | 크기 | SHA256 |
|---|---|---|
| bokuno_ko_batch5z_20260910_98.xdelta | 636,306 B | `4035416b26979a939e34b2caf245500aaedaa50d77fe5e8cc250ffedc1d9e46a` |
| 원본 ぼくのProto1.123.smc (적용 전) | 8,388,608 B | `4793E1422295B8C13BA81B070B941288D36BE339FF20F914652CE63CC06F2DA0` |
| 결과 bokuno_ko.smc (적용 후) | 8,388,608 B | `02AE4AE27686875480AB14B31D63E65A9CE282813C3B7015F70AC5F8ACB5D9C2` |

저장소에도 최신 xdelta 한 벌을 두었습니다([예비 다운로드](https://github.com/beck4679-alt/bokuno-rs3-ko/raw/main/bokuno_ko_batch5z_20260910_98.xdelta)). 이전 판은 각 Release 에서 받을 수 있습니다.
