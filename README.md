...
- 에롤에게 비는 대사·뮤즈의 꿈 속 대사 등에서 문장 끝 「!」「.」「....」이나 끝말이 혼자 다음 줄로 떨어지던 곳을 고쳤습니다.
- 창 크기(좁은 창·넓은 창)에 따라 줄이 넘어가는 대사를 두 창 모두에서 확인했습니다.

v0.111의 가변폭 글꼴·번역 손질·주인공 말투 정리는 그대로 들어 있습니다. [v0.111 변경](docs/releases/v0.111.md)

v0.111까지의 수정을 포함하는 누적 패치입니다. [자세한 수정·검증 범위](docs/releases/v0.112.md)
